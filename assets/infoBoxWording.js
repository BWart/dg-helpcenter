function fillInfoBoxWording(){
    ...
    //Level 0: Wo ist meine Bestellung?
        ...
        "outputReadyForShipment" : "Erst wenn alle Produkte deiner Bestellung versandbereit sind, wird die Bestellung versendet. Soll es schneller gehen kannst du eine <a href='https://helpcenter.digitec.ch/hc/de/articles/115005646225-Wie-löse-ich-eine-Teillieferung-aus-' target='blank'>kostenlose Teillieferung aktivieren</a>.",
    ...
    //Level 0: Probleme mit einer Bestellung
        ...
        "outputNotWorking" : "Sollte ein Produkt defekt sein und es sich um einen Garantiefall handeln, dann musst du in deinem Kundenkonto einen <a href='https://www.digitec.ch/de/Warranty/Overview' target='blank'>Defekt anmelden</a>.<br><br>Beschädigungen, welche auf unsachgemässe Bedienung zurückzuführen sind, fallen nicht unter Garantie. Weitere Informationen findest du in unseren <a href='https://www.digitec.ch/de/wiki/559' target='blank'>Garantierichtlinien</a> sowie in unseren <a href='https://www.digitec.ch/Wiki/478' target='blank'>AGBs</a>.",
  ...
  //Level 0: Kundenkonto
          ...
          "outputDeleteAccount" : "Nachdem dein Konto gelöscht wurde, hast du keinen Zugriff mehr auf deine elektronischen Kaufbelege und andere Unterlagen. Wir empfehlen dir daher, eine Kopie der noch benötigten Formulare zu drucken oder abzuspeichern, bevor du dein Konto löschen lässt.<br><br>Du kannst die Löschung direkt über dein <a href='https://www.digitec.ch/DeleteAccount' target='blank'>Benutzerkonto</a> einleiten.",
      ...
      "outputDeleteAccountDescriptionLabel" : "Beschreibung<br>Hinweis: Für eine rasche Bearbeitung benötigen wir deine Kundennummer",
          ...
          "outputCantLogin" : "Du kannst dein Passwort jederzeit zurücksetzen und ein neues zusenden lassen:<br><br>•	Klicke im Login-Bereich auf <a href='https://www.digitec.ch/de/Register/RequestPassword' target='blank'>Passwort vergessen?</a><br>•	Gib deinen Benutzernamen oder die hinterlegte E-Mail-Adresse an und klicke auf \"Link anfordern\"",
  ...
  //Level 0: Offerte
    ...
    //FRANZÖSISCH
                  ...
                  "outputOtherRequest" : "Dans l'<a href='https://www.digitec.ch/fr/Order' target='blank'>aperçu des commandes</a> de votre compte client, vous pouvez consulter les dernières informations relatives au statut de livraison de vos produits et tous les reçus, certificats de garantie.<br><br>Si un produit est défectueux et s'il peut être pris en charge par la garantie, vous devez aller dans votre compte client pour <a href='https://www.digitec.ch/fr/Warranty/Overview' target='blank'>signaler un défaut</a>.",

        //Level 0: Ou est ma commande?
        "Vérifier l'état de ma commande" : "inputOrderStatus",
        "outputOrderStatus" : "Dans l'<a href='https://www.digitec.ch/fr/Order' target='blank'>aperçu des commandes</a> de votre compte client, vous pouvez consulter les dernières informations relatives au statut de livraison de vos produits. Vous y trouverez également le numéro de suivi de votre colis.",

        "Le statut de l'envoi est « expédié », mais l'envoi n'est pas arrivé" : "inputShippingStatus",
    ...
    //Level 0: Problème avec la commande
        ...
        "outputNotWorking" : "Si un produit est défectueux et s'il peut être pris en charge par la garantie, vous devez aller dans votre compte client pour <a href='https://www.digitec.ch/fr/Warranty/Overview' target='blank'>signaler un défaut</a>.<br><br>Les dommages causés par une utilisation inappropriée ne sont pas couverts par la garantie. Vous trouverez un complément d'information concernant ce point dans nos <a href='https://www.digitec.ch/fr/wiki/559' target='blank'>conditions de garantie</a> et <a href='https://www.digitec.ch/Wiki/478' target='blank'>CGV</a>.",
    ...
    //Level 0: Retour
          ...
          "outputReturn" : "Les produits achetés directement chez digitec peuvent être retournés dans les 30 jours, ceux achetés auprès d'un <a href='https://helpcenter.digitec.ch/hc/fr/articles/360012370979-Offres-de-fournisseur-tiers' target='blank'>fournisseur tiers</a>, dans les 14 jours suivant leur réception. Vous pouvez <a href='https://www.digitec.ch/fr/ReturnsAndWarranty' target='blank'>enregistrer un retour</a> directement dans votre compte client.",

  //Level 0: Paiement et remboursement
          "Remboursement de mon avoir" : "inputCreditReturn",
          "outputCreditReturn" : "Vous pouvez effectuer vous-même le remboursement d'un avoir en quelques étapes. La procédure exacte est décrite dans le présent <a href='https://helpcenter.digitec.ch/hc/fr/articles/360000457949-Que-faire-pour-lancer-le-processus-de-remboursement-' target='blank'>article</a>.<br><br>Veuillez noter que le virement prend habituellement entre 1 à 3 jours ouvrables.<br><br>Les remboursements sur votre carte de crédit figureront sur votre prochain relevé de carte de crédit.",

          "J'ai besoin d'un reçu/une facture" : "inputReceipt",
          "outputReceipt" : "Vous trouverez tous les reçus, certificats de garantie et autres à la rubrique <a href='https://www.digitec.ch/fr/Order' target='blank'>commandes</a> dans votre compte client en sélectionnant la commande souhaitée.<br><br>Vous trouverez <a href='https://www.digitec.ch/fr/Invoice/ListInvoices' target='blank'>ici</a> un justificatif de facture pour les commandes payées sur facture.",
  ...
  //Level 0: Compte client
      ...
      "outputDeleteAccountDescriptionLabel" : "Description<br>Note : Pour un traitement rapide, nous avons besoin de votre numéro de client",
          ...
          "outputCantLogin" : "Vous pouvez à tout moment réinitialiser votre mot de passe pour qu'un nouveau vous soit envoyé : <br><br>•	Cliquez dans la zone de connexion sur <a href='https://www.digitec.ch/fr/Register/RequestPassword' target='blank'>mot de passe oublié ?</a><br>•	Saisissez votre nom d'utilisateur ou adresse électronique fournie et cliquez sur « Demander un lien »",
  ...
  //Level 0: Offre
    ...
    //ITALIENISCH
      it: {
        ...
        "Altre domande" : "inputOtherRequest" ,
                  "outputOtherRequest" : "Trovi informazioni più dettagliate sullo stato di consegna dei tuoi articoli, tutte le ricevute d'acquisto, i certificati di garanzia e altro nel tuo conto cliente alla voce <a href='https://www.digitec.ch/it/Order' target='blank'>ordini</a>.<br><br>Se un prodotto è difettoso e se si tratta di un caso coperto dalla garanzia, devi notificare il danno tramite il tuo conto cliente alla voce <a href='https://www.digitec.ch/it/Warranty/Overview' target='blank'>segnala un difetto</a>.",

    //Level 0: Dove si trova il mio ordine?
        "Verificare lo stato del mio ordine" : "inputOrderStatus",
        "outputOrderStatus" : "Trovi informazioni più dettagliate sullo stato di consegna dei tuoi articoli nel tuo conto cliente alla voce <a href='https://www.digitec.ch/it/Order' target='blank'>ordini</a>. Trovi, inoltre, anche il numero di tracking del tuo pacco.",

        "Sullo stato della spedizione è indicato «spedito», ma la spedizione non è arrivata" : "inputShippingStatus",
        "outputShippingStatus": "Trovi informazioni più dettagliate sullo stato di consegna dei tuoi articoli nel tuo conto cliente alla voce <a href='https://www.digitec.ch/it/Order' target='blank'>ordini</a>. Trovi, inoltre, anche il numero di tracking del tuo pacco.<br><br>Purtroppo, a volte la consegna del pacco può avere ritardi oppure essere recapitato a un indirizzo errato. Se il pacco non dovesse arrivare dopo qualche giorno, avvieremo una ricerca.",
        ...
        "outputReadyForShipment" : "Solo quando tutti i prodotti del tuo ordine saranno pronti per essere spediti, l'ordine verrà inviato. Se vuoi che sia più veloce, puoi attivare gratuitamente la <a href='https://helpcenter.digitec.ch/hc/it/articles/115005646225-Come-faccio-a-richiedere-una-consegna-parziale-' target='blank'>consegna parziale</a>.",
    ...
    //Level 0: Problemi con un ordine
        ...
        "outputReceivedNotEverything" : "Non tutti i prodotti provengono direttamente dal nostro magazzino. I prodotti dei nostri partner ti vengono consegnati direttamente in un pacchetto separato. Nel menu <a href='https://www.digitec.ch/it/Order' target='blank'>ordini</a> puoi anche vedere se il tuo pacco è già stato spedito o se è ancora in fase di preparazione.",

                  "Desidero stornare un ordine" : "inputCancelOrder",
                  "outputCancelOrder" : "Finché il tuo ordine non è stato preparato per la spedizione, puoi stornare l’ordine del prodotto che non vuoi più acquistare direttamente nel tuo conto cliente alla voce <a href='https://www.digitec.ch/it/Order' target='blank'>ordini</a>. Se il prodotto è già stato spedito, puoi registrare il reso nel tuo conto cliente cliccando su <a href='https://www.digitec.ch/it/Return' target='blank'>registra il reso</a>.",
  ...
  //Level 0: Pagamento e rimborso
          ...
          "outputCreditReturn" : "Puoi avviare il rimborso di un credito autonomamente. La procedura esatta è descritta in questo <a href='https://helpcenter.digitec.ch/hc/it/articles/360000457949-Come-faccio-a-richiedere-il-rimborso-' target='blank'>articolo</a>.<br><br>Si prega di notare che il trasferimento di denaro di solito richiede da 1 a 3 giorni lavorativi.<br><br>I rimborsi sulla carta di credito appariranno sul prossimo estratto conto della carta di credito.",
