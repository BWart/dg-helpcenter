function fillInfoBoxWording(){
      ...
      infoBoxWording = {
        ...
        "webform_case_missing_product" : {
              'de' : "Nicht immer werden alle Produkte in einem Paket geliefert.<br>Die aktuellen Informationen zum Lieferstatus und deiner Produkte findest du in der <a href='" + shopURL + "Order' target='blank'>Bestellübersicht</a> in deinem Kundenkonto.<br>Zudem erhälst du für jede Lieferung eine separate Versandbestätigung",
              'fr' : "Tous les produits ne sont pas toujours livrés en un seul colis.<br>Vous pouvez trouver les informations actuelles sur l'état de la livraison et vos produits dans la rubrique <a href='" + shopURL + "Order' target='blank'>aperçu de la commande</a> dans votre compte client.<br>En outre, vous recevrez une confirmation d'expédition distincte pour chaque livraison.",
              'it' : "Non tutti i prodotti sono sempre consegnati in un unico pacco.<br>Puoi trovare le informazioni attuali sullo stato di consegna e i tuoi prodotti nel <a href='" + shopURL + "Order' target='blank'>riassunto dell'ordine</a> nel tuo account cliente.<br>Inoltre, riceverai una conferma di spedizione separata per ogni consegna.",
              'en-US' : "Not all products are always delivered in one package.<br>You can find the latest information about the delivery status and your products in the <a href='" + shopURL + "Order' target='blank'>order overview</a> in your customer account.<br>In addition, you will receive a separate shipping confirmation for each delivery."
        },
