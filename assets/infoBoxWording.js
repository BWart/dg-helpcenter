function fillInfoBoxWording(){
      ...
      infoBoxWording = {
        ...
        "webform_case_wrong_product" : {
              ...
              'fr' : "Afin que nous puissions vérifier rapidement votre demande, veuillez nous fournir le numéro du fabricant ou le code EAN (code-barres) du produit reçu de manière incorrecte.<br>Vous trouverez ces informations sur l'emballage du produit.<br>Vous trouverez plus d'informations sur le code EAN <a href='" + helpcenterURL + "articles" + hp7 + "' target='blank'>ici</a>.",
              'it' : "Affinché possiamo controllare rapidamente la sua richiesta, la preghiamo di fornirci il numero del produttore o il codice EAN (codice a barre) del prodotto ricevuto in modo errato.<br>Troverete le informazioni sulla confezione del prodotto.<br>Puoi trovare maggiori informazioni sul codice EAN <a href='" + helpcenterURL + "articles" + hp7 + "' target='blank'>qui</a>.",
              'en-US' : "To enable us to quickly check your request, please provide us with the manufacturer number or EAN code (barcode) of the incorrectly received product. You can find the information on the product packaging.<br>You can find more information about the EAN-code <a href='" + helpcenterURL + "articles" + hp7 + "' target='blank'>here</a>.",
