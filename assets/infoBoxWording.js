function fillInfoBoxWording(){
    ...
    "outputButtonFeedback" : {
      ...
      if (customerType == 'business-customer') {
        infoBoxWording['webform_case_delete_account']['de'] = 'Nachdem dein Konto gelöscht oder deaktiviert wurde, hast du keinen Zugriff mehr auf deine elektronischen Kaufbelege und andere Unterlagen. Wir empfehlen dir daher, eine Kopie der noch benötigten Formulare zu drucken oder abzuspeichern, bevor du dein Konto löschen lässt.<br><br>Firmenkunden können unseren Kundendienst kontaktieren, um die Deaktivierung ihres Kontos zu veranlassen.';
        infoBoxWording['webform_case_delete_account']['fr'] = "Une fois que ton compte a été supprimé ou désactivé, tu n'as plus accès à tes preuves d'achat électroniques et autres documents. De ce fait, nous vous recommandons d'imprimer ou de sauvegarder une copie des formulaires dont vous avez encore besoin avant de supprimer votre compte.<br><br>Les entreprises clientes peuvent contacter notre service clientèle pour demander la désactivation de leur compte.";
        infoBoxWording['webform_case_delete_account']['it'] = 'Dopo la cancellazione o la disattivazione del vostro account, non avrete più accesso alle vostre ricevute di acquisto elettroniche e ad altri documenti. Pertanto, consigliamo di stamparne o salvare una copia delle ricevute e dei moduli prima di cancellare il tuo conto in maniera definitiva.<br><br>I clienti aziendali possono contattare il nostro servizio clienti per disattivare il proprio account.';
        infoBoxWording['webform_case_delete_account']['en-US'] = 'After your account is deleted or deactivated, you will no longer have access to your electronic purchase receipts and other records. That’s why we recommend making a copy (printing out a hard copy or saving an electronic one) before you ask us to delete your account.<br><br>Corporate customers can contact our customer service to have their account deactivated.';
    }}
