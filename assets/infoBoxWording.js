function fillInfoBoxWording() {
      ...
      var infoBoxWording = {
            ...
            "webform_case_shipping_status": {
                  ...
                  'nl': "Helaas kan een zending soms wat langer op zich laten wachten of in meerdere pakketten worden verzonden. Als de zending na vijf dagen na verzending nog niet is aangekomen, stellen wij graag een onderzoek in.<br>Actuele informatie over de leveringsstatus vindt u in het <a href='" + shopURL + "Order' target='blank'>besteloverzicht</a> in uw klantenaccount.",
            ...
            "webform_case_ready_for_shipment": {
                  ...
                  'nl': "Pas als alle producten van uw bestelling op voorraad zijn, wordt de bestelling verzonden. Als u wilt dat het sneller gaat, kunt u een <a href='" + helpcenterURL + "articles" + hp1 + "-Wie-löse-ich-eine-Teillieferung-aus-' target='blank'>gratis deellevering activeren</a>."
            },
