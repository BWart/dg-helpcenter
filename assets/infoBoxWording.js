function fillInfoBoxWording(){
      ...
      infoBoxWording = {
        ...
        "webform_case_wrong_product" : {
              'de' : "Damit wir dein Anliegen rasch prüfen können, stelle uns die Herstellernummer oder den EAN-Code (Strichcode) des falsch erhaltenen Produkt zur Verfügung. Der EAN-Code befindet sich auf der Produktverpackung und dient dazu ein Produkt zweifelsfrei zu identifizieren. Er besteht aus einem Strichcode, respektive Barcode, und 13 Ziffern:<div style=width:100%;text-align:center;'><img style='width:200px;' src='https://helpcenter.galaxus.ch/hc/article_attachments/4410101322642/ean13.gif'/></div>",
              'fr' : "Afin que nous puissions vérifier rapidement votre demande, veuillez nous fournir le numéro du fabricant ou le code EAN (code-barres) du produit reçu de manière incorrecte.  Le code EAN se trouve sur l'emballage du produit et permet d'identifier un produit sans aucun doute. Il se compose d'un code-barres et de 13 chiffres :<div style=width:100%;text-align:center;'><img style='width:200px;' src='https://helpcenter.galaxus.ch/hc/article_attachments/4410101322642/ean13.gif'/></div>",
              'it' : "Affinché possiamo controllare rapidamente la sua richiesta, la preghiamo di fornirci il numero del produttore o il codice EAN (codice a barre) del prodotto ricevuto in modo errato. Il codice EAN si trova sulla confezione del prodotto e serve per identificare un prodotto senza alcun dubbio. Consiste in un codice a barre e 13 cifre:<div style=width:100%;text-align:center;'><img style='width:200px;' src='https://helpcenter.galaxus.ch/hc/article_attachments/4410101322642/ean13.gif'/></div>",
              'en-US' : "To enable us to quickly check your request, please provide us with the manufacturer number or EAN code (barcode) of the incorrectly received product. The EAN code can be found on the product packaging and is used to identify a product without any doubt. It consists of a barcode and 13 digits:<div style=width:100%;text-align:center;'><img style='width:200px;' src='https://helpcenter.galaxus.ch/hc/article_attachments/4410101322642/ean13.gif'/></div>",
