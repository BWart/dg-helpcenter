function fillInfoBoxWording(){
    ...
    infoBoxWording = {
      ...
      "webform_case_wrong_product" : {
            ...
            en : "To be able to check your request quickly, it would be helpful if you could provide us with the manufacturer's number or the EAN code of the incorrectly received product. You can find this information on the product packaging."
      },
      ...
      "webform_case_return" : {
            ...
            en : "You have 30 days to return products sold by " + seite + " and 14 days to return items sold by <a href='" + helpcenterURL + "articles" + hp2 + "-Buying-from-third-party-sellers' target='blank'>third parties</a> from the day you received them. <a href='" + shopURL + "after-sales' target='blank'>Register returns</a> in your customer account."
      },
      "webform_case_return_status" : {
            ...
            en : "Go to <a href='" + shopURL + "ServiceCase/List' target='blank'>all returns</a> to find an overview and the current status of all your returns and warranty cases."
      },
